...
| `qosConfiguration` | OPTIONAL - Integer equal to either `0` (at most once, default value) or `1` (at least once); determines the QoS with which the client subscribes to configuration updates
